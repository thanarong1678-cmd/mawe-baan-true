...
function ensureStockStyles() {
  ...
  style.textContent = `
    ...
    .mawe-stock-controls{grid-column:2;display:flex;justify-content:flex-end;gap:5px}.mawe-stock-controls button{width:27px;height:24px;border:0;border-radius:9px;background:#ffe0aa;color:#8a4b20;font-weight:900;cursor:pointer}.mawe-stock-controls button:last-child{background:#ffbd63;color:#fff}
    ...
    .mawe-header-note:before{content:'•';position:absolute;left:50%;top:-21px;font-size:34px;color:#8a461d}.mawe-header-sleepy{position:absolute;right:95px;bottom:-18px;font-size:92px;filter:drop-shadow(0 7px 4px rgba(124,45,18,.16));z-index:5;line-height:1}.mawe-header-paws{position:absolute;right:315px;top:15px;font-size:28px;opacity:.35;transform:rotate(-10deg);z-index:1}.mawe-header-paws:after{content:'🐾  🐾';display:block;transform:translate(28px,35px) rotate(12deg)}
    .mawe-header-quote{display:flex!important;align-items:center;justify-content:space-between!important;gap:8px;width:min(620px,100%)!important;max-width:none!important;padding:11px 17px!important;border-radius:999px!important;background:rgba(255,239,211,.38)!important;border:2px solid rgba(255,255,255,.74)!important;color:#7b451d!important;font-size:14px!important;font-weight:800!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.55),0 4px 12px rgba(124,45,18,.06)!important}.mawe-header-quote .mawe-arrow{font-size:29px;color:#fff;text-shadow:0 2px 3px rgba(124,45,18,.12);line-height:1}.mawe-header-quote-text{flex:1;text-align:center;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
    header>div:first-child>div:first-child{width:100%}header>div:first-child>div:first-child>div:first-child{width:112px;height:112px;font-size:54px;border-width:5px;flex:none}header h1{font-size:43px!important;line-height:1!important;color:#fff!important;text-shadow:0 3px 8px rgba(124,45,18,.2)}header h1+button{font-size:16px!important;padding:9px 18px!important;border-radius:999px!important;background:rgba(126,78,22,.68)!important}header>div:first-child>div:nth-child(2){flex:1;min-width:0}
    @media(max-width:1450px){.mawe-header-stock{right:220px}.mawe-stock-card{width:150px}.mawe-header-sleepy{right:55px}.mawe-header-note{display:none}}
    @media(max-width:1100px){.mawe-header-stock{right:18px;top:auto;bottom:14px;transform:none}.mawe-stock-card{min-height:88px;width:140px}.mawe-header-sleepy{display:none}.mawe-header-paws{display:none}}
    @media(max-width:800px){.mawe-header-stock{display:none}header h1{font-size:28px!important}header>div:first-child>div:first-child>div:first-child{width:82px;height:82px;font-size:40px}.mawe-header-quote{width:100%!important;font-size:12px!important}.mawe-header-note{display:none}}
  `
...
export default function CatHeaderDynamic() {
  ...
  const updateHeader = useCallback(async () => {
    ...
    if (oldBubble) {
      ...
      const q = oldBubble.querySelector('.mawe-header-quote-text')
      if (q) q.textContent = HEADER_QUOTES[Math.floor(Math.random()*HEADER_QUOTES.length)]
    }
