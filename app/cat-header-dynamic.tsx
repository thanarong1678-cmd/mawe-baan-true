...
function ensureStockStyles() {
  ...
  style.textContent = `
    ...
    .mawe-header-quote .mawe-arrow{font-size:29px;color:#fff;text-shadow:0 2px 3px rgba(124,45,18,.12);line-height:1}.mawe-header-quote-text{flex:1;text-align:center;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}

    /* ไอคอนแมว: ล็อกเป็นสี่เหลี่ยมจัตุรัส ไม่ให้ถูกยืด */
    header>div:first-child>div:first-child{
      width:112px!important;height:112px!important;min-width:112px!important;min-height:112px!important;
      flex:0 0 112px!important;font-size:54px!important;border-width:5px!important;
      display:flex!important;align-items:center!important;justify-content:center!important;
      overflow:hidden!important;aspect-ratio:1/1!important;
    }
    header>div:first-child>div:first-child > svg{width:46px!important;height:46px!important;max-width:46px!important;max-height:46px!important;flex:none!important;aspect-ratio:1/1!important}
    ...
    @media(max-width:767px){
      ...
      header>div:first-child>div:first-child > svg{width:46px!important;height:46px!important;max-width:46px!important;max-height:46px!important}
    ...
    @media(min-width:1101px) and (max-width:1450px){.mawe-header-stock{right:220px}.mawe-stock-card{width:150px}.mawe-header-sleepy{right:55px}.mawe-header-note{display:none}}
